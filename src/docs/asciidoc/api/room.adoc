...
include::{snippets}/leave-room-success/http-request.adoc[]

==== HTTP Response

include::{snippets}/leave-room-success/http-response.adoc[]
include::{snippets}/leave-room-success/response-fields.adoc[]
